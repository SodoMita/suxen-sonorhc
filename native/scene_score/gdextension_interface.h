/* Generated from Godot 4.7 core/extension/gdextension_interface.json.
 * Declarations follow the Godot Engine GDExtension C ABI (MIT). */
#pragma once
#ifndef __cplusplus
#include <stddef.h>
#include <stdint.h>
...
typedef struct GDExtensionCallError GDExtensionCallError;
typedef struct GDExtensionCallableCustomInfo GDExtensionCallableCustomInfo;
typedef struct GDExtensionCallableCustomInfo2 GDExtensionCallableCustomInfo2;
typedef struct GDExtensionClassCreationInfo GDExtensionClassCreationInfo;
typedef struct GDExtensionClassCreationInfo2 GDExtensionClassCreationInfo2;
typedef struct GDExtensionClassCreationInfo3 GDExtensionClassCreationInfo3;
typedef struct GDExtensionClassCreationInfo4 GDExtensionClassCreationInfo4;
typedef struct GDExtensionClassCreationInfo6 GDExtensionClassCreationInfo6;
typedef struct GDExtensionClassMethodInfo GDExtensionClassMethodInfo;
typedef struct GDExtensionClassVirtualMethodInfo GDExtensionClassVirtualMethodInfo;
typedef struct GDExtensionGodotVersion GDExtensionGodotVersion;
typedef struct GDExtensionGodotVersion2 GDExtensionGodotVersion2;
typedef struct GDExtensionInitialization GDExtensionInitialization;
typedef struct GDExtensionInstanceBindingCallbacks GDExtensionInstanceBindingCallbacks;
typedef struct GDExtensionMainLoopCallbacks GDExtensionMainLoopCallbacks;
typedef struct GDExtensionMethodInfo GDExtensionMethodInfo;
typedef struct GDExtensionPropertyInfo GDExtensionPropertyInfo;
typedef struct GDExtensionScriptInstanceInfo GDExtensionScriptInstanceInfo;
typedef struct GDExtensionScriptInstanceInfo2 GDExtensionScriptInstanceInfo2;
typedef struct GDExtensionScriptInstanceInfo3 GDExtensionScriptInstanceInfo3;

typedef void (*GDExtensionVariantFromTypeConstructorFunc)(GDExtensionUninitializedVariantPtr arg0, GDExtensionTypePtr arg1);
typedef void (*GDExtensionTypeFromVariantConstructorFunc)(GDExtensionUninitializedTypePtr arg0, GDExtensionVariantPtr arg1);
typedef void* (*GDExtensionVariantGetInternalPtrFunc)(GDExtensionVariantPtr arg0);
...
typedef GDExtensionObjectPtr (*GDExtensionClassConstructor)(void);
...
typedef void (*GDExtensionWorkerThreadPoolGroupTask)(void* arg0, uint32_t arg1);
typedef void (*GDExtensionWorkerThreadPoolTask)(void* arg0);
...
typedef void (*GDExtensionMainLoopStartupCallback)(void);
typedef void (*GDExtensionMainLoopShutdownCallback)(void);
typedef void (*GDExtensionMainLoopFrameCallback)(void);
